...
#define S_FUNCTION_NAME        RTICANMM_SETUP_CAVPCM                                                                                          
...
#include "RTICANMM_SETUP_CAVPCM.h"                                                                                                    
...
#define NUM_OUT         10                               /* Number of Output Ports */                              
/* defines for rx service */                                                                                       
#define PZS_TJA_COMM_CH         6                                                                                 
                                                                                                                   
                                                                                                                           
#define CAN_BOARDNUMBER                                     1                                                     
#define CAN_BOARD_BASE                                  DS2202_1_BASE                                             
...
#define DO_CONTROL_BUS                                                                                             
  #if defined(DO_CONTROL_BUS)																				  
    static DsTCanBusStat      MyBusStat; 
    static DsSCanBusStat_Data MyData;    
  #endif  /* DO_CONTROL_BUS */                                                                                 
static Float64 CANMM_CTL_SETUP_CAVPCM_baudrate      = 500.0;                                                                                 
static Float64 CANMM_CTL_SETUP_CAVPCM_baudrate_in   = 500.0; /* Temporary for input port value */                                            
static Float64 CANMM_CTL_SETUP_CAVPCM_baudrate_old  = 500.0;                                                                                 
...
#define OUTDEF_BUSSTATE   ((int32_T*) ssGetOutputPortSignal(S, 0))[0] /* Status */                                                    
#define OUTDEF_STUFFBITERROR   ((int32_T*) ssGetOutputPortSignal(S, 1))[0] /* Stuff errors */                                                    
#define OUTDEF_FORMERROR   ((int32_T*) ssGetOutputPortSignal(S, 2))[0] /* Format errors */                                                    
#define OUTDEF_ACKERROR   ((int32_T*) ssGetOutputPortSignal(S, 3))[0] /* Ack errors */                                                    
#define OUTDEF_BIT0ERROR   ((int32_T*) ssGetOutputPortSignal(S, 4))[0] /* Bit 0 errors */                                                    
#define OUTDEF_BIT1ERROR   ((int32_T*) ssGetOutputPortSignal(S, 5))[0] /* Bit 1 errors */                                                    
#define OUTDEF_CRCERROR   ((int32_T*) ssGetOutputPortSignal(S, 6))[0] /* CRC errors */                                                    
#define OUTDEF_LOSTRX   ((int32_T*) ssGetOutputPortSignal(S, 7))[0] /* RX lost */                                                    
#define OUTDEF_SUCCRECRX   ((int32_T*) ssGetOutputPortSignal(S, 8))[0] /* RX ok */                                                    
#define OUTDEF_SUCCSENTTX   ((int32_T*) ssGetOutputPortSignal(S, 9))[0] /* TX ok */                                                    
#if defined(RTICANMM_HAVE_VALID_PLATFORM)                                                                                   
...
static DsSCanCh_Status CanMM_channel_Status;                                                                   
                                                                                                                   
                                                                                                                   
volatile UInt8 CANMM_CTL_SETUP_CAVPCM_ID;                                                                                              
volatile UInt8 CANMM_CTL_SETUP_CAVPCM_TX_STATUS                 = 1;                                                                   
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_CAVPCM_Variation        = 1;                                                                   
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_CAVPCM_VariationSwitch  = 0;                                                                   
...
#endif                                                                                                           
volatile UInt8   CANMMMonitor_CAVPCM     = 0;                                                                                     
volatile UInt8   CANMMMonitor_CAVPCM_old = 0;                                                                                     
volatile dsfloat MonitoringTimeStamp_CAVPCM = 0.0;                                                                                       
...
static CANMM_CTL_CLIENT_TYPE(CANMM_CTL_SETUP_CAVPCM) ctlsetup_client;                                                                
#endif /* RTICANMM_DSDAQ_SERVICEID */                                                                            
                                                                                                                 
                                                                                                                   
void                                                                                                               
CANMM_CTL_SETUP_CAVPCM_baudrate_set(Float64 baudrate) {                                                                                
  ...
  if ((Error = DsCanCh_apply(CanMM_channel)) != DSCAN_NO_ERROR)                                                    
    ...
    CANMM_CTL_SETUP_CAVPCM_baudrate = baudrate;                                                                                        
  }                                                                                                                
}                                                                                                                  
...
#if defined(RTICANMM_HAVE_VALID_PLATFORM)                                                                          
static SimStruct * RTICANMM_SETUP_CAVPCM_SimStruct = 0;                                                                               
void backgroundFunction_22021143421()                                                                                       
{                                                                                                                  
  SimStruct *S = RTICANMM_SETUP_CAVPCM_SimStruct;                                                                                     
...
void DECLSPEC CANMM_CTL_SETUP_CAVPCM_client_init(CANMM_CTL_SETUP_CAVPCM_CtlClient* client) {                                                               
  DsTError          Error         = DSCAN_NO_ERROR;                                                                
  ...
  if (!client->initialized) {                                                                                      
    ...
    if ((Error = DsCanMsg_setQueueSize(client->tx_msg, CANMM_CTL_SETUP_CAVPCM_tx_queue_size)) != DSCAN_NO_ERROR)                       
      CANMM_DEBUG_ERROR(Error);                                                                                    
#if (defined(DSCAN_VER_MAR) && DSCAN_VER_MAR == 1) || defined(RTICANMM_HAVE_DSRT)                                  
 ...
 * available.                                                                                                      
 */                                                                                                                
Int32 DECLSPEC CANMM_CTL_SETUP_CAVPCM_rx(CANMM_CTL_SETUP_CAVPCM_CtlClient* client, CanMM_Msg* msg) {                                                       
 ...
 */                                                                                                                
Int32 DECLSPEC CANMM_CTL_SETUP_CAVPCM_tx(CANMM_CTL_SETUP_CAVPCM_CtlClient* client, CanMM_Msg* msg) {                                                       
  UInt32      k = 0;                                                                                               
  DsTError Error = DSCAN_NO_ERROR;                                                                                 
  DsSCanMsg_Item msg_item;                                                                                         
 ...
 * If CANMM_CTL_SETUP_CAVPCM_rx_stop has been issued before, the receive buffer (mcr) is cleared                                       
 * for the calling client. Messages received in the inactive period thus will                                      
 * not be received.                                                                                                
 */                                                                                                                
void DECLSPEC CANMM_CTL_SETUP_CAVPCM_rx_start(CANMM_CTL_SETUP_CAVPCM_CtlClient* client) {                                                                  
  DsTError          Error         = DSCAN_NO_ERROR;                                                                
 ...
 * CANMM_CTL_SETUP_CAVPCM_rx function. To continue reception of messages CANMM_CTL_SETUP_CAVPCM_rx_start                                                   
 * has to be called.                                                                                               
 */                                                                                                                
void DECLSPEC CANMM_CTL_SETUP_CAVPCM_rx_stop(CANMM_CTL_SETUP_CAVPCM_CtlClient* client) {                                                                   
  DsTError          Error         = DSCAN_NO_ERROR;                                                                
...
Float64 DECLSPEC CANMM_CTL_SETUP_CAVPCM_baudrate_get() {                                                                               
  return CANMM_CTL_SETUP_CAVPCM_baudrate;                                                                                              
}                                                                                                                  
                                                                                                                   
/**                                                                                                                
* Return the no of message waiting for transmit                                                                    
*/                                                                                                                 
UInt32 DECLSPEC CANMM_CTL_SETUP_CAVPCM_tx_queue_level(CANMM_CTL_SETUP_CAVPCM_CtlClient* client) {                                                          
  UInt32   tx_count = 0;                                                                                           
  DsTError Error;                                                                                                  
  ...
  if ((Error = DsCanMsg_getTxQueueCount(client->tx_msg, &tx_count)) != DSCAN_NO_ERROR) {                           
    ...
    tx_count = CANMM_CTL_SETUP_CAVPCM_tx_queue_size;                                                                                   
  }                                                                                                                
  return tx_count;                                                                                                 
}                                                                                                                  
...
/****************************/                                                                                     
  ...
  ssSetOutputPortDataType(S, 0, SS_INT32);   /* Status */                                                               
  ssSetOutputPortDataType(S, 1, SS_INT32);   /* Stuff errors */                                                               
  ssSetOutputPortDataType(S, 2, SS_INT32);   /* Format errors */                                                               
  ssSetOutputPortDataType(S, 3, SS_INT32);   /* Ack errors */                                                               
  ssSetOutputPortDataType(S, 4, SS_INT32);   /* Bit 0 errors */                                                               
  ssSetOutputPortDataType(S, 5, SS_INT32);   /* Bit 1 errors */                                                               
  ssSetOutputPortDataType(S, 6, SS_INT32);   /* CRC errors */                                                               
  ssSetOutputPortDataType(S, 7, SS_INT32);   /* RX lost */                                                               
  ssSetOutputPortDataType(S, 8, SS_INT32);   /* RX ok */                                                               
  ssSetOutputPortDataType(S, 9, SS_INT32);   /* TX ok */                                                               
...
# endif /* RTICANMM_HAVE_DSCAN_BUS */                                                                              
  ...
  if ((Error = DsCanCh_setDescriptor(CanMM_channel, "CAVPCM")) != DSCAN_NO_ERROR)                                      
    CANMM_DEBUG_ERROR(Error);                                                                                      
                                                                                                                   
  if ((Error = DsCanCh_setBaudRate(CanMM_channel, (int)CANMM_CTL_SETUP_CAVPCM_baudrate*1000)) != DSCAN_NO_ERROR)                   
      CANMM_DEBUG_ERROR(Error);                                                                                
  ...
  if(S != 0)                                                                                                      
       RTICANMM_SETUP_CAVPCM_SimStruct = S;                                                                                          
...
# endif                                                                                                            
#if defined(RTICANMM_DSDAQ_SERVICEID)																				  
    CANMM_CTL_CLIENT_INIT(CANMM_CTL_SETUP_CAVPCM, &ctlsetup_client);                                                                   
    CANMM_CTL_RX_STOP(CANMM_CTL_SETUP_CAVPCM, &ctlsetup_client);      /* Start disabled */                                             
# endif                                                                                                            
...
/****************************/                                                                                     
  ...
  if(S != 0)                                                                                                       
      RTICANMM_SETUP_CAVPCM_SimStruct = S;     //just to be safe we do one more assigment                                             
#endif /* RTICANMM_HAVE_VALID_PLATFORM */                                                                          
}                                                                                                                          
#endif /*  MDL_START */                                                                                                    
...
#if defined(RTICANMM_DSDAQ_SERVICEID)                                                                            
if (CANMMMonitor_CAVPCM > 0 && !(CANMMMonitor_CAVPCM_old > 0)) { /* monitoring enabled */                                                          
  CANMM_CTL_RX_START(CANMM_CTL_SETUP_CAVPCM, &ctlsetup_client);                                                                      
}                                                                                                                
if (!(CANMMMonitor_CAVPCM > 0) && CANMMMonitor_CAVPCM_old > 0) { /* monitoring disabled */                                                         
  CANMM_CTL_RX_STOP(CANMM_CTL_SETUP_CAVPCM, &ctlsetup_client);                                                                       
}                                                                                                                
CANMMMonitor_CAVPCM_old = CANMMMonitor_CAVPCM;                                                                                                     
                                                                                                                 
if (CANMMMonitor_CAVPCM > 0) {                                                                                                    
  while (CANMM_CTL_RX(CANMM_CTL_SETUP_CAVPCM, &ctlsetup_client, &canmm_msg)) {                                                       
    UInt32 i = 0;                                                                                                
    int j = 0, k = 0;                                                                                            
...
#endif                                                                                                           
    MonitoringTimeStamp_CAVPCM = canmm_msg.TimeStamp;                                                                                    
  ...
  if (CANMM_CTL_SETUP_CAVPCM_VariationSwitch == 0) {                                                                                   
    CANMM_CTL_SETUP_CAVPCM_ID = INDEF_VARIATION;                                                                                       
  }                                                                                                                
  else {                                                                                                           
    CANMM_CTL_SETUP_CAVPCM_ID = CANMM_CTL_SETUP_CAVPCM_Variation;                                                                                          
  }                                                                                                                
  ...
  if ((Error = DsCanCh_getStatus (CanMM_channel, &CanMM_channel_Status)) != DSCAN_NO_ERROR)                    
    CANMM_DEBUG_ERROR(Error);                                                                                  
                                                                                                               
                                                                                                                   
    DsCanBusStat_getData(MyBusStat, &MyData);   
    { 
      DsECanCh_BusState DsECanChBusState;                       
      DsCanCh_getBusState( CanMM_channel, &DsECanChBusState );  
      OUTDEF_BUSSTATE      =  -1; 
      switch(DsECanChBusState)                                  
      {                                                         
        case DSCAN_CH_STATE_INIT        : OUTDEF_BUSSTATE      =  0; break;
        case DSCAN_CH_STATE_ERR_ACTIVE  : OUTDEF_BUSSTATE      =  0; break;
        case DSCAN_CH_STATE_WARNING     : OUTDEF_BUSSTATE      =  1; break;
        case DSCAN_CH_STATE_ERR_PASSIVE : OUTDEF_BUSSTATE      =  1; break;
        case DSCAN_CH_STATE_BUSOFF      : OUTDEF_BUSSTATE      =  2; break;
        case DSCAN_CH_STATE_SLEEP       : OUTDEF_BUSSTATE      =  2; break;
      }                                                         
      //we add 10% tolerance to cancel jitter effect                                                                     
      if (MyData.TimeStamp - oldBusStat_TimeStamp >= (Float64)(MONITORING_SLEEPTIME - (MONITORING_SLEEPTIME * 0.01)) &&     
          oldBusStat_TimeStamp != MyData.TimeStamp)    
      {                                                                      
          oldBusStat_TimeStamp = MyData.TimeStamp;                             
      OUTDEF_STUFFBITERROR  = OUTDEF_STUFFBITERROR + MyData.NumStuffErrors;   
      OUTDEF_FORMERROR      = OUTDEF_FORMERROR + MyData.NumFormErrors;   
      OUTDEF_ACKERROR       = OUTDEF_ACKERROR + MyData.NumAckErrors;     
      OUTDEF_BIT0ERROR      = OUTDEF_BIT0ERROR + MyData.NumBit0Errors;   
      OUTDEF_BIT1ERROR      = OUTDEF_BIT1ERROR + MyData.NumBit1Errors;   
      OUTDEF_CRCERROR       = OUTDEF_CRCERROR + MyData.NumCrcErrors;     
      OUTDEF_LOSTRX         = CanMM_channel_Status.LostRxMessages;                                
      OUTDEF_SUCCRECRX      = OUTDEF_SUCCRECRX + MyData.NumRxStdFrames + MyData.NumRxExtFrames;   
      OUTDEF_SUCCSENTTX     = OUTDEF_SUCCSENTTX + MyData.NumTxStdFrames + MyData.NumTxExtFrames;  
      }                                                                      
                                                                             
      if (resetStateVars){                                                       
          OUTDEF_BUSSTATE      = 0;                                          
          OUTDEF_STUFFBITERROR = 0;                                          
          OUTDEF_FORMERROR     = 0;                                          
          OUTDEF_ACKERROR      = 0;                                          
          OUTDEF_BIT0ERROR     = 0;                                          
          OUTDEF_BIT1ERROR     = 0;                                          
...
/****************************/                                                                                     
  ...
  CANMMMonitor_CAVPCM_old = 0;                                                                                                      
  if ((Error = DsCanCh_stop(CanMM_channel)) != DSCAN_NO_ERROR)                                                     
    CANMM_DEBUG_ERROR(Error);                                                                                      
    RTICANMM_SETUP_CAVPCM_SimStruct = 0;                                                                                              
#endif   /* RTICANMM_HAVE_VALID_PLATFORM */                                                                        
}                                                                                                                          
